...
class ColectieElementFrecventa:
    ...
    def adauga(self, e):
        ...
        # 1. Daca elementul apare deja in colectie, ii incrementam frecventa
        # 2. Daca elementul nu apare deja in colectie, il adaugam, cu frecvent 1
        gasit = False
...
class IteratorColectieFrecventa:
    ...
    def urmator(self):
        ...
        # (1)
        # strict mai mica decat sau
        # (2)
        #egala cu frecventa elementului curent in colectia iterata

        # Daca frecventa curenta a elementului curent
        # este strict mai mica decat frecventa elementului
        # curent in colectia iterata, incrementam frecventa curenta
        # Daca frecventa curenta a elementului curent este egala cu frecventa elementului
        # curent in colectia iterata, trecem la elementul urmator, incrementand indexul curent
        # si reinitializand frecventa curenta cu 1
